...
import json
import os
from . import (fast_apply, place_pivot, add_modifiers, helper_panel, 
               operators, preview_panel)

modules = [fast_apply, place_pivot, add_modifiers, helper_panel,
           operators, preview_panel]
...
def register():
    ...
    bpy.app.handlers.load_post.append(load_post)  # Добавляем обработчик загрузки

def unregister():
    save_settings()  # Сохраняем настройки перед удалением
